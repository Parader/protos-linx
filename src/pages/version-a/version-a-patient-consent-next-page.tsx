...
export function VersionAPatientConsentNextPage() {
    const { patients } = useVersionA();
    ...
    if (!patientId) {
        return <Navigate to="/version-a/patient-consent" replace />;
    }
                ...
                <article className="overflow-hidden rounded-2xl border border-[#E4E6EA] bg-white shadow-[0px_4px_24px_rgba(16,24,40,0.06)]">
                    ...
                    <div className="px-6 py-8 sm:px-8">
                        ...
                        <div className="mt-10 flex flex-col items-center gap-3">
                            <Button size="lg" className="w-full bg-[#0573d8] text-white hover:bg-[#0460b8] sm:w-auto" href="/version-a">
                    ...
                    <footer className="border-t border-[#EEF0F4] bg-[#FAFBFC] px-6 py-4 text-center">
                        <Link to="/version-a" className="inline-flex justify-center">
                            <img
