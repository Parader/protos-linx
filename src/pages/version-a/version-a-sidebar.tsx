            ...
            <div className="flex min-h-0 w-full flex-1 flex-col justify-between">
                <div className="flex flex-col gap-6 pt-6">
                    <div className="pl-6 pr-3">
                        <NavLink to="/version-a" className="inline-flex" aria-label="Akinox">
                    ...
                    <nav className="flex flex-col gap-1 px-3">
                        <NavLink to="/version-a" end className={({ isActive }) => cx(isActive ? navItemActiveClass : "p-0.5")}>
                            {({ isActive }) => (
                                <span
