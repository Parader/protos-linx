...
export function VersionAPatientConsentPage() {
    const { consentPatients, acceptConsent } = useVersionA();
            ...
            <div className="mx-auto flex w-full max-w-[680px] flex-col px-4 py-8 pb-16">
                ...
                {consentPatients.length === 0 ? (
                    <div className="rounded-2xl border border-[#E4E6EA] bg-white p-10 text-center shadow-[0px_4px_24px_rgba(16,24,40,0.06)]">
                        ...
                        <Button className="mt-6" color="secondary" size="md" href="/version-a">
                                    ...
                                    <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                        <Button
                                            ...
                                            onClick={() => {
                                                ...
                                                navigate("/version-a/patient-consent/next", { state: { patientId } });
                                            }}
                                        >
