...
export function NotFound() {
    ...
    const n = strings.common.notFound;
                ...
                <div className="flex w-full max-w-3xl flex-col gap-8 md:gap-12">
                    <div className="flex flex-col gap-4 md:gap-6">
                        <div className="flex flex-col gap-3 md:gap-6">
                            <span className="text-md font-semibold text-brand-secondary">{n.badge}</span>
                            <h1 className="text-display-md font-semibold text-primary md:text-display-lg lg:text-display-xl">{n.title}</h1>
                        </div>
                        <p className="text-lg text-tertiary md:text-xl">{n.body}</p>
                    </div>
