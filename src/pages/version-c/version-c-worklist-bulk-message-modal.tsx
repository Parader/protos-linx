...
import { staffMessageTemplateBody, type MessageTemplateId } from "@/pages/version-c/version-c-staff-message-templates";
...
export function VersionCWorklistBulkMessageModal({ isOpen, onOpenChange }: Props) {
    const { strings, locale } = useVEDLocale();
    const { patients, patientsByColumn, sendStaffMessage } = useVersionC();
    const msg = strings.versionC.pages.messagingBulk;
    const templates = strings.versionC.pages.messageTemplates;
