...
export function VersionCSidebar() {
    return (
            ...
            <div className="flex min-h-0 w-full flex-1 flex-col justify-between">
                <div className="flex flex-col gap-6 pt-6">
                    <div className="pl-6 pr-3">
                        <NavLink to="/version-c" className="inline-flex" aria-label="Akinox">
                    ...
                    <nav className="flex flex-col gap-1 px-3">
                        <NavLink to="/version-c" end className={({ isActive }) => cx(isActive ? navItemActiveClass : "p-0.5")}>
                            {({ isActive }) => (
                                <span
                                ...
                                >
                                    ...
                                    <span className="text-base font-medium leading-6 text-[#475467]">Liste de travail</span>
                                </span>
                            )}
                        </NavLink>

                        <NavLink to="/version-c/reports" className={({ isActive }) => cx(isActive ? navItemActiveClass : "p-0.5")}>
                            {({ isActive }) => (
                                <span
                                    className={cx(isActive ? navItemActiveInnerClass : navItemClass)}
                                    aria-current={isActive ? "page" : undefined}
                                >
                                    ...
                                    <span className="text-base font-medium leading-6 text-[#475467]">Rapports et statistiques</span>
                                </span>
                            )}
                        </NavLink>

                        <NavLink to="/version-c/patient" className={({ isActive }) => cx(isActive ? navItemActiveClass : "p-0.5")}>
                            {({ isActive }) => (
                                <span
                                    className={cx(isActive ? navItemActiveInnerClass : navItemClass)}
                                    aria-current={isActive ? "page" : undefined}
                                >
                                    ...
                                    <span className="text-base font-medium leading-6 text-[#475467]">Vue patient</span>
                                </span>
                            )}
                        </NavLink>
                    </nav>
                ...
                <div className="flex flex-col gap-6 px-4 pb-3">
                    <div className="flex flex-col gap-1">
                        ...
                        >
                            ...
                            <span className="text-base font-medium leading-6 text-[#475467]">Aide</span>
                        </button>
                    </div>
