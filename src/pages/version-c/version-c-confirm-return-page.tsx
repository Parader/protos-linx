...
import { fullName, type PatientStatus } from "@/pages/version-c/version-c-shared";
...
export function VersionCConfirmReturnPage() {
    const { strings } = useVEDLocale();
    const location = useLocation();
    const pub = strings.versionC.pages.publicChrome;
    const cr = strings.versionC.pages.confirmReturn;

    const { patients, confirmReturn, cancelQueueRequestFromPatient } = useVersionC();
