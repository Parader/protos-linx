...
export function VersionCSinglePatientMessageModal({ patientId, onDismiss }: Props) {
    const { strings, locale } = useVEDLocale();
    const { patients, sendStaffMessage } = useVersionC();
    const msg = strings.versionC.pages.messagingSingle;
