...
import { ALL_STAFF_MESSAGE_OPTIONS } from "@/pages/version-b/version-b-staff-messages";
...
export function VersionBStaffMessageDialog({ isOpen, onOpenChange, mode, waitingCount = 0, patientName, onSend }: Props) {
