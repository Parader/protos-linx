...
export function getVersionCdPagesCore(locale: VEDLocale): VersionCdPagesCore {
    ...
    return {
        ...
        exitDistance: {
            ...
            bodyWithdraw: t(
                "Retirer votre consentement vous retire complètement du service de rappel et de suivi à distance. Vous ne recevrez plus de messages liés à votre place dans la file d’attente virtuelle.",
                "Withdrawing consent removes you completely from recall and remote follow-up. You will no longer receive messages about your place in the virtual waiting queue.",
            ),
            bodyCancelManual: t(
